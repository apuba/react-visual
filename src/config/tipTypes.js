 ...
 * @Last Modified time: 2019-08-30 13:57:51
 */

export const GRID_COL_TIP = '栅格把每行平均分来24列'
export const GRID_GUTTER_TIP = '格式: "10px"、"0 10px"、"10px 0 2px 4px"'
export const DATABIND_MODEL_TIP = '把当前组件的值绑定到一个对象上'
